    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        if (sender instanceof Player p) {
            ...
            if (args.length == 0) {
                ...
                if (target != null) {
                    target.setGameMode(GameMode.SPECTATOR);
                    target.sendMessage(ChatColor.WHITE + "Your Gamemode Have Been Updated To " + ChatColor.GREEN + "Spectator Mode " + ChatColor.WHITE + "By " + Console.getName() + ChatColor.WHITE + ".");
